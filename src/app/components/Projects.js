            ...
            <article key={post.id} className="flex max-w-xl flex-col items-start justify-between">
              <div className="flex items-center gap-x-4 text-xs">
                ...
                <a
                  ...
                  className="relative z-10 rounded-full border-none bg-white/15 px-3 py-1.5 font-medium hover:bg-gray-100"
                >
                  {post.category.title}
                </a>
              </div>
              <div className="group relative">
                <h3 className="mt-3 text-lg/6 font-semibold group-hover:text-stone-200">
                  <a href={post.href}>
