        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="p-6 hover:text-yellow-500 transition-colors">
              ...
              {/* Fine Progress Bar */}
              <div className="w-full bg-gray-700 h-1 mb-4 rounded-lg">
                <div className="bg-yellow-500 h-1 rounded-lg" style={{ width: '40%' }}></div>
              </div>
            ...
            <div className="p-6 hover:text-yellow-500 transition-colors">
              ...
              {/* Fine Progress Bar */}
              <div className="w-full bg-gray-700 h-1 mb-4 rounded-lg">
                <div className="bg-yellow-500 h-1 rounded-lg" style={{ width: '50%' }}></div>
              </div>
              <h3 className="text-2xl font-semibold mb-4">Bootstrap</h3>
              <p className="text-gray-400">
                Responsive design framework for modern web apps.
              </p>
            </div>
            ...
            <div className="p-6 transition-colors" style={{ filter: 'grayscale(100%)', opacity: 0.5 }}>
              ...
              <p className="text-gray-400">Coming Soon</p> {/* Python web framework. */}
            </div>
  
            {/* Coming Soon for Docker */}
            <div className="p-6 transition-colors" style={{ filter: 'grayscale(100%)', opacity: 0.5 }}>
              <img
              ...
              <p className="text-gray-400">Coming Soon</p> {/* Containerization platform. */}
            </div>
            ...
            <div className="p-6 hover:text-yellow-500 transition-colors">
              ...
              {/* Fine Progress Bar */}
              <div className="w-full bg-gray-700 h-1 mb-4 rounded-lg">
                <div className="bg-yellow-500 h-1 rounded-lg" style={{ width: '5%' }}></div>
              </div>
